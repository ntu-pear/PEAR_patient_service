...
@router.get("/Guardian", response_model=PatientPatientGuardianByGuardian)
...
@router.get("/Guardian/GetGuardianByNRIC", response_model=PatientPatientGuardianByGuardian)
...
@router.get("/Guardian/GetPatientGuardian", response_model=PatientPatientGuardianByPatient)
