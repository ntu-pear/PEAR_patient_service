...
def create_new_social_history_sensitive_mapping(request: Request, social_history_item: str, social_history_sensitive_mapping: SocialHistorySensitiveCreate, db: Session = Depends(get_db), require_auth: bool = True):
    ...
    return create_sensitive_mapping(db=db, social_history_item=social_history_item, social_history=social_history_sensitive_mapping, created_by=1)
