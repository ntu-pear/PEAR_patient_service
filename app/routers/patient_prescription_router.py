...
@router.put("/Prescription/update", response_model=schemas_prescription.PatientPrescription)
...
@router.put("/Prescription/delete", response_model=schemas_prescription.PatientPrescription)
