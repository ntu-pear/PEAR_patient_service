...
print(f"DB_SERVER_DEV: {DB_SERVER_DEV}")
print(f"DB_DATABASE_DEV: {DB_DATABASE_DEV}")
print(f"DB_DATABASE_PORT: {DB_DATABASE_PORT}")
print(f"DB_USERNAME_DEV: {DB_USERNAME_DEV}")
